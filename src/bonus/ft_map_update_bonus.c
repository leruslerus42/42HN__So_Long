...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_map_update_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rrajaobe <rrajaobe@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/04 22:57:59 by rrajaobe          #+#    #+#             */
/*   Updated: 2021/12/05 04:08:26 by rrajaobe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
*	Sime function, I will just test every iteration if it occurs a game over 
*	and at the end I move the enemy
*/
