...
/*   Updated: 2021/12/05 01:45:36 by rrajaobe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
-Werror -Wextra -Wall 
gcc  main.c ft_initialization.c ft_get_next_line.c ft_map_update.c ft_map_reader.c ft_map_printer.c ft_movements.c ft_error_management.c ft_enemy.c ./libft/ft_bzero.c ./libft/ft_strdup.c ./libft/ft_itoa.c ./libft/ft_strjoin.c ./libft/ft_strlen.c ./libft/ft_substr.c ./mlx/libmlx.a -framework OpenGL -framework AppKit
*/
...
void	map_creation(struct s_game *game, char *s);
...
int		ft_error_wrong_inputs_in_map(char c);
